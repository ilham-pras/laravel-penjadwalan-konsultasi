  ...
  <div class="sidebar-wrapper active">
    <div class="sidebar-header position-relative">
      <div class="d-flex justify-content-between align-items-center">
        <div class="logo">
          <a href="{{ route('home') }}">
            <img src="{{ asset('./assets/compiled/png/logo.png') }}" style="width: 120px; height: auto;" alt="Logo" srcset="" />
          </a>
        </div>
        {{-- Change Theme --}}
    ...
    <div class="sidebar-menu">
      <ul class="menu">
        ...
        <li class="sidebar-item {{ Route::currentRouteName() === 'kalender.index' ? 'active' : '' }}">
        ...
        <li class="sidebar-item has-sub {{ Request::is('data-penjadwalan*') ? 'active' : '' }}">
          <a href="#" class="sidebar-link">
            <i class="bi bi-table"></i>
            <span>Data Penjadwalan</span>
          </a>
          <ul class="submenu">
            <li class="submenu-item {{ Request::is('data-penjadwalan/jadwal*') ? 'active' : '' }}">
              <a href="{{ route('jadwal.index') }}" class="submenu-link">Jadwal Konsultasi</a>
            </li>

            <li class="submenu-item {{ Request::is('data-penjadwalan/jam*') ? 'active' : '' }}">
              <a href="{{ route('jam.index') }}" class="submenu-link">Jam Operasional</a>
            </li>

            <li class="submenu-item {{ Request::is('data-penjadwalan/jenis*') ? 'active' : '' }}">
